...
const NavigationJobs = () => {
  return (
    <div className="group">
      <h2 className="card-one">Navigation Jobs </h2>
      <div className="absolute top-[100px] left-[-60px]  group-hover:bg-sky-500 w-[280px] h-[100px]">
...
//   return (
//     <div className="group">
//       <h2 className="">Navigation Jobs</h2>
